...
public class VerticalSliceSprite {
    ...
    private VerticalSliceSprite(int texWidth, int texHeight, Sprite[] slices) {
    ...
    public int getWidth() {
        return this.slices[CENTER].width;
    }
    ...
    public static class Builder {
        ...
        public VerticalSliceSprite build() {
            ...
            return new VerticalSliceSprite(this.texWidth, this.texHeight, slices);
        }
