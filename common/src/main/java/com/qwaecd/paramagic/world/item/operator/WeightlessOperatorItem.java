...
public class WeightlessOperatorItem extends ParaOperatorItem {
    public WeightlessOperatorItem() {
        super(WeightlessOperator.OP_ID);
    }
    ...
    protected void appendDescribeHoverText(ItemStack stack, @Nullable Level level, List<Component> components, TooltipFlag isAdvanced) {
        Component describe = Component.translatable("tooltip.paramagic.weightless_operator.describe").withStyle(ChatFormatting.GRAY);
