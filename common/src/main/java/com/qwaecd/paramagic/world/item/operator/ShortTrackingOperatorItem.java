...
public class ShortTrackingOperatorItem extends ParaOperatorItem {
    public ShortTrackingOperatorItem() {
        super(ShortTrackingOperator.OP_ID);
    }
    ...
    protected void appendDescribeHoverText(ItemStack stack, @Nullable Level level, List<Component> components, TooltipFlag isAdvanced) {
        Component describe = Component.translatable("tooltip.paramagic.short_tracking_operator.describe").withStyle(ChatFormatting.GRAY);
