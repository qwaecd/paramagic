...
public final class ModEntityTypes {
    ...
    public static void init(EntityTypeProvider provider) {
        ...
        LASER_PROJECTILE = create(provider, "laser_projectile", LaserProjectile::new, MobCategory.MISC, builder -> builder.sized(0.2F, 0.2F).updateInterval(20).clientTrackingRange(8));
        ...
        GRAVITY_COLLAPSE_ENTITY = create(provider,"gravitational_collapse", GravityCollapseEntity::new, MobCategory.MISC, builder -> builder.sized(0.5F, 0.5F).updateInterval(10));
    }
