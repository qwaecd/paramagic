...
import com.qwaecd.paramagic.thaumaturgy.operator.content.GravityCollapseOperator;
...
public class GravityCollapseOperatorItem extends ParaOperatorItem {
    ...
    protected void appendDescribeHoverText(ItemStack stack, @Nullable Level level, List<Component> components, TooltipFlag isAdvanced) {
        Component describe = Component.translatable("tooltip.paramagic.gravity_collapse_operator.describe").withStyle(ChatFormatting.GRAY);
