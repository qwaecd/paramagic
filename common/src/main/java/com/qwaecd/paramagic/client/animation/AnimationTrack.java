...
public class AnimationTrack {
    ...
    public void apply(float time) {
        ...
        if (startValue instanceof Float f1 && endValue instanceof Float f2) {
            targetProperty.setValue(Interpolation.linear(f1, f2, alpha));
        } else if (startValue instanceof Vector3f v1 && endValue instanceof Vector3f v2) {
            targetProperty.setValue(Interpolation.linear(v1, v2, alpha, this.tempValue.vct3));
            ...
            targetProperty.setValue(Interpolation.linear(v1, v2, alpha, this.tempValue.vct4));
        } else {
